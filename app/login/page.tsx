...
import { Mail, Lock, ArrowRight, Smartphone, AlertCircle } from "lucide-react";
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center lg:text-left space-y-2">
            ...
            <p className="text-sm text-muted-foreground font-semibold">
              Access your Phonix account to save orders in MongoDB.
            </p>
          </div>
          ...
          <div className="p-4 bg-muted/40 rounded-xl border text-center">
            <p className="text-[11px] text-muted-foreground font-semibold leading-relaxed">
              🔒 <strong>MongoDB Authentication</strong>: Your credentials are safe. If your MongoDB URI is not connected yet, the app falls back to a high-fidelity server in-memory database.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="hidden lg:flex relative overflow-hidden bg-slate-950 text-white flex-col justify-between p-12">
        ...
        <div className="relative z-10 space-y-6 max-w-md my-auto">
          <h2 className="text-4xl font-extrabold leading-tight tracking-tight">
            The Smartest Way to Secure Your Next Device.
          </h2>
          <p className="text-slate-400 text-sm leading-relaxed">
            Create an account or login to save your favorite products, manage your cart, place orders, and track shipping histories in real-time.
          </p>
          <div className="flex gap-4">
            <div className="flex flex-col">
              <span className="text-2xl font-black text-primary">100%</span>
              <span className="text-[10px] uppercase font-bold text-slate-500 tracking-wider">Secured Auth</span>
            </div>
            <span className="w-[1px] bg-slate-800" />
            <div className="flex flex-col">
              <span className="text-2xl font-black text-accent">MongoDB</span>
              <span className="text-[10px] uppercase font-bold text-slate-500 tracking-wider">Data Cluster</span>
            </div>
          </div>
        </div>
